...
// ---------------------------------------------------------------------------
// Muqsit Health System: the ONLY change to this file is the export below, so
// the rule table above can be imported as an ES module. Taken verbatim from
// the npm package avro-phonetic@1.1.5 (src/avro-lib.js), which is licensed
// under the Mozilla Public License 1.1 (MPL-1.1.txt beside this file).
export default OmicronLab.Avro.Phonetic;
